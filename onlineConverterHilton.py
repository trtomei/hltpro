...
f2.write('\n')
f2.write('options.register (\'transferMode\',\n') 
f2.write('                  \'\', # default value \n')
f2.write('                  VarParsing.VarParsing.multiplicity.singleton,\n') 
f2.write('                  VarParsing.VarParsing.varType.string,          # string, int, or float\n') 
f2.write('                  "Selected transfer mode propagated by RCMS")\n') 
f2.write('\n')
...
f2.write('\n')
f2.write('try:\n') 
f2.write('     process.EvFDaqDirector.selectedTransferMode = options.transferMode\n') 
f2.write('except:\n') 
f2.write('     print "unable to set process.EvFDaqDirector.selectedTransferMode=",options.transferMode\n') 
f2.close()
